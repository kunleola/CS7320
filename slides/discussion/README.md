...
## Module 3: Solving Problems by Search: Tree Search
...
## Module 4: Search in Complex Environments: Local Search 
...
## Module 5: Search in Complex Environments: Search with Uncertainty 
...
## Module 6: Adversarial Search and Games 
...
* Supplemental:
    ...
    - [Video: Why do Monte Carlo simulations work?](https://youtu.be/7ESK5SaP-bc?si=4-OUEg1tc3ab3-vm)
    - [How AlphaZero plays Chess](https://arxiv.org/abs/1712.01815)


## Module 7: Constraint Satisfaction Problem 

* Reading: AIMA Chapter 6
* [Lecture presentation slides](../06_CSP.pdf)
* No sync session presentation slides
* No code examples


## Module 8: Knowledge-based Agents
...
## Module 10: Quantifying Uncertainty: Bayesian Decision-Making
...
## Module 11: Probabilistic Reasoning: Bayesian Networks
...
## Module 12: Making Simple Decisions: Decision Networks

* Reading: AIMA Chapter 16
* [Lecture presentation slides](../16_decision_making.pdf)
* No sync session presentation slides
* No code examples


## Module 13: Learning from Examples: Supervised Machine Learning
